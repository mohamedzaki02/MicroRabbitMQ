...
namespace MicroRabbit.Infra.Bus
{
    public sealed class RabbitMQBus : IEventBus
    {
        ...
        public RabbitMQBus(IMediator mediator, IServiceScopeFactory factory)
        {
            _mediator = mediator;
            _factory = factory;
        ...
        public void Publish<T>(T @event) where T : Event
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                channel.BasicPublish("", eventName, null, System.Text.Encoding.UTF8.GetBytes(JsonSerializer.Serialize(@event)));
            }
        }
            ...
            where TH : IEventHandler<T>
        {
            ...
            if (!_handlers.ContainsKey(eventType.Name)) _handlers.Add(eventType.Name, new List<Type>());
            if (_handlers[eventType.Name].Any(eh => eh.GetType() == handlerType))
